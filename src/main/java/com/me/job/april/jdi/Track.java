...
/**
 * 假定远端打包并启动
 * java -jar -agentlib:jdwp=transport=dt_socket,address=127.0.0.1:50008,suspend=n,server=y remote-1.0-SNAPSHOT.jar
 */
public class Track {
    //要调试的目标程序的监听地址
    public static final String HOST = "127.0.0.1";
    //要调试的目标程序的监听端口
    public static final String PORT = "50008";
    //要调试的目标程序的类全名
    public static final String CLS_NAME = "base.JdiDemo";
    //类中要监控的变量字段名
